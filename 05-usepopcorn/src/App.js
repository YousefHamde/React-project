    ...
    return (
        <>
            ...
            <Main >
                <Box>
                    {isLoading && <Loader />}
                    {!isLoading && !error && <MovieList onSelectedMovie={handelSelectMovie} movies={movies} />}
...
function Loader() {
    return <p style={loader} className="loader">Loading...</p>;
}
...
function MovieDetails({ selectedId, onCloseMovie, onAddWatched, watched }) {
    ...
    // const rate = Math.trunc(imdbRating);
    function handleAdd() {
